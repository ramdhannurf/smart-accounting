...
export default function PurchaseInvoice({ params }: { params: { type: string } }) {
    ...
    useEffect(() => {
        ...
        } else if (params.type === "purchase_orders") {
            setTitle("Pemesanan Pembelian");
        } else if (params.type === "purchase_offer") {
            setTitle("Penawaran Pembelian");
        } else {
            router.push("/404");
        }
    }, [params.type]);
                            ...
                            <div className="flex flex-col gap-5">
                                ...
                                <div className="grid 2xl:grid-cols-4 xl:grid-cols-4 md:grid-cols-3 grid-cols-1 gap-5">
                                    ...
                                    <div className="flex flex-col gap-5">
                                        ...
                                        {
                                            params.type !== "purchase_offer" && <div className="flex flex-col gap-2">
                                                <Label>Gudang</Label>
